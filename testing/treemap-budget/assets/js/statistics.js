...
stats = {
    amount: {
        ...
        side: function () {
            return " in " + (avb.navbar.getCurrentMonthName()).toString() + "."
        },
        cellClass: "value sum ",
 ...
 */
    ...
    growth: {
        ...
        side: " compared to previous month.",
        cellFunction: function (d, cell) {
...
function formatcurrency(value) {
    if (value === undefined) {
        ...
        return "-$" + Math.abs(Math.round(value / 1000000)).toString() + " M";
    } else if (value > -1000000 && value <= -1000) {
        return "-$" + Math.abs(Math.round(value / 1000)).toString() + " K";
    } else if (value >= 1000000) {
