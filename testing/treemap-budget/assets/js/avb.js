...
function initialize() {
  ...
  $revenuesItem = $("span[data-section='revenues']")
  $expensesItem = $("span[data-section='expenses']")
  ...
  $expensesItem.on('click', function(event) {
    event.preventDefault();
    $revenuesItem.removeClass('selected');
    $(this).addClass('selected');
    params.section = "expenses";
    initializeVisualizations(params);
  });

  $revenuesItem.on('click', function(event) {
    event.preventDefault();
    $expensesItem.removeClass('selected');
    $(this).addClass('selected');
